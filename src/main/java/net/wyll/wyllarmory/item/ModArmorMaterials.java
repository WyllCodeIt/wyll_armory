...
public enum ModArmorMaterials implements ArmorMaterial {
    //list of all armor types
    PRIMORDIAL("primordial", 24, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 5.0F, 0.15F, () -> Ingredient.of(ModItems.PRIMORDIAL_GEM.get()));
    ...
    public String getName() {
        return WyllArmory.MOD_ID + ":" + this.name;
    }
